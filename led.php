...
?>
 ...
 <!-- Modal -->
  <div class="modal fade bd-example-modal-sm" id="myModal" role="dialog" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog modal-sm">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title" style="margin-bottom: -10px;"><strong><div><p id="modalrack"></p></div></strong></h4>
        </div>
	...
	<form id="form"  onsubmit="return false;">
	 ...
	 <br>
        ...
        <div class="modal-footer">
          <input type="submit" class="btn btn-default" data-dismiss="modal" value="Ok" onclick="entradaTecnico()">
        </div>
       </form>
      </div>
...
function seleccion(mode) {
    ...
    } else if (res[1] == "tecnico") {
      seleccionTecnico(res[0], res[1]);
    } else {
      window.location.href='?id=' + res[0] + '&mode=' + res[1];
    }
}

function seleccionTecnico(idrack, mode) {
  document.getElementById("modalrack").innerHTML = "Entrada técnico: " + idrack
  document.getElementById("modalrack").value = idrack;
  $("#myModal").modal();
}

function entradaTecnico() {
